        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-brand-800/40">
          <thead className="bg-brand-50 dark:bg-brand-900/40">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium uppercase text-brand-700 dark:text-brand-300/70">Usuário</th>
              <th className="px-4 py-3 text-left text-xs font-medium uppercase text-brand-700 dark:text-brand-300/70">Perfil</th>
